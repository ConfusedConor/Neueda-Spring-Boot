...
public class ByVolumeService {
	...
	public ArrayList<ByVolume> buildingsbyvolume(){
		...
		//Info
		ByVolume bv1 = new ByVolume("Boeing Everett Factory", "United States", "Everett, Washington", "398,000", "13.3 million", "Boeing's assembly site for a selection of the company's largest aircraft, originally built for construction of the 747.", "bfp4.jpg", "<iframe src=\"https://www.google.com/maps/embed?pb=\" width=\"100%\" height=\"450\" frameborder=\"0\" style=\"border:0\" allowfullscreen></iframe>" );
