...
public class WeatherController {
	...
	public String belfast(@PathVariable("location") String location, Model model) {
		...
		String locationWeatherUrl= "http://www.codingfury.net/training/weathersample/weather.php?location=" + location;
		RestTemplate restTemplate = new RestTemplate();
		TodaysWeather todaysWeather = restTemplate.getForObject(locationWeatherUrl, TodaysWeather.class);
		...
		logger.info(todaysWeather.getWind().toString());
